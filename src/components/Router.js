...
import EditJob from './layout/EditJob'
import MyWork from './layout/MyWork'
      ...
      <ThemeProvider theme={theme}>
        ...
        <Container>
          ...
          <Switch>
            ...
            <PrivateRoute exact path="/job/edit" component={EditJob} />
            <PrivateRoute exact path="/work" component={MyWork} />
          </Switch>
        </Container>
      </ThemeProvider>
    </BrowserRouter>
